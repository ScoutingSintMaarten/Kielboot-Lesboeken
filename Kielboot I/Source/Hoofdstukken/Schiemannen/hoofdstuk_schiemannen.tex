...
Deze knoop wordt veel gebruikt met pionieren en om je boot aan te leggen. De knoop trekt zich zelf strakker wanneer er meer kracht op komt.
\begin{figure}[h]
  \centering
  \begin{minipage}[b]{0.32\textwidth}
  \centering
...
De paalsteek is bedoeld om een lus in een touw te leggen. De lus is erg sterk, maar kan wel gemakkelijk weer los gehaald worden.
\subsection{Dubbele halve steek \hfill \textit{Figuur \ref{pic:dub_halve_steek}}}
Een dubbele halve steek is geschikt om lijnen strak aan een oog vast te maken. Dit is bijvoorbeeld handig als je aan wilt leggen met een meerpen. Je wikkelt eerst de lijn twee maal om een oog en legt er vervolgens twee halve steken in. Dit maakt een mastworp. Je kan de eerste halve steek ook vervangen door een slipsteek.
