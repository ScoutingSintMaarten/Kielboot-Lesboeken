...
\definecolor{ocre}{RGB}{50, 65, 154} % Define the orange color used for highlighting throughout the book
...
%Changed by CP; Default is 15, new is 6.5pt.
{\addvspace{6.5pt}\large\sffamily\bfseries} % Spacing and font options for chapters 
...
\ifnum \value{part}=1 %added by CP. If first 
\node[anchor=south east] at (\paperwidth-1cm,-\paperheight+2.1cm){\parbox[t][][t]{8.5cm}{
...
\makeatother
\node[anchor=south east] at (\paperwidth-1cm,-\paperheight+0.8cm) {\parbox[t][][t]{10cm}{
...
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= ocre,bookmarks=true,bookmarksopen=false,
	pdftitle={Kielboot III - Scouting Sint Maarten},
	pdfauthor={Christian Peppelman},
	pdfsubject={Kielboot III - Zeiltheorie met focus op Scouting},
	pdfkeywords={CWO Kielboot III},
}
\usepackage{bookmark}
\bookmarksetup{
open,
...
\newcommand{\answerTextPictureSmall}[5]{
	\begin{figure}[H]	
		\vspace{-10px}
		\begin{minipage}[]{0.70\textwidth}
			\begin{enumerate}[topsep=0pt, label=\Alph*.]
		...
		\begin{minipage}[]{0.29\textwidth}
			\begin{figure}[H]
				\includegraphics[width=0.70\textwidth,right]{#5}
			\end{figure}
		\end{minipage}
		\vspace{-10px}
	\end{figure}
